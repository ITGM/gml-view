...
class G_RSI extends G_Indicator {
  ...
  render(ctx, data, options) {
    ...
    rsiData.forEach((value, index) => {
      ...
      const y =
        padding.top + (height - padding.top - padding.bottom) - value * yScale
    ...
    ctx.moveTo(
      padding.left,
      padding.top + (height - padding.top - padding.bottom) - 70 * yScale
    )
    ctx.lineTo(
      width - padding.right,
      padding.top + (height - padding.top - padding.bottom) - 70 * yScale
    ...
    ctx.moveTo(
      padding.left,
      padding.top + (height - padding.top - padding.bottom) - 30 * yScale
    )
    ctx.lineTo(
      width - padding.right,
      padding.top + (height - padding.top - padding.bottom) - 30 * yScale
